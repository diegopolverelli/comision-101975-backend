...
export const register = async (req, res) => {
    ...
    // si passport.authenticate salia OK, dejaba un req.user con datos del usuario autenticado

    res.setHeader('Content-Type', 'application/json');
    return res.status(201).json({ payload: `Login exitoso`, newUser: req.user });
}